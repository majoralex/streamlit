...
sample_data = {
    'text': [
        ...
        "A third sample sentence to demonstrate the app.",
        "This is the fourth sample sentence in the set.",
        "The fifth sample sentence is also included.",
...
def main():
    st.set_page_config(
        page_title="WordCloud | n-gram Generator",
        page_icon="⛅",
        layout="wide",
